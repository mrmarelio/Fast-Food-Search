...
<body>
                    ...
                    <ul class="dropdown-menu">
                        <?php
                            ...
                            while($result = mysqli_fetch_assoc($run)){
                                echo "
                                <li><a class ='dropdown-item' href='kategorijos.php'>".$result['Cat_Name']."</a></li>
            ...
            <div class="col-lg-3">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#">A-Z</a></li>
                        <li><a href="#">Z-A</a></li>
                        <li><a href="#">Pigiausi viršuje</a></li>
                        <li><a href="#">Brangiausi viršuje</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
    <?php
        $title = mysqli_real_escape_string($conn, $_GET['kategorija']);
        $sql = "SELECT * FROM produktas WHERE cat_ID = '$title'";
